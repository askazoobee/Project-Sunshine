...
public class Utility {
    ...
    static public Boolean isNetworkAvailable(Context c){
        ...
        //return true if connected or attempting to connect.
...
@SuppressWarnings("ResourceType")
    ...
    int getLocationStatus(Context c){
        ...
        return sp.getInt(c.getString(R.string.pref_status_key), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
    }
    ...
    void resetLocationStatus(Context c){
        ...
        spe.putInt(c.getString(R.string.pref_status_key), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
        spe.apply();
    }
